...
export function TrainingForm({
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    formData.append("data", toBrazilianDate(data.data));
    formData.append("horario_inicio", data.horarioInicio || "00:00");
    formData.append(
      "horario_fim",
      data.horarioFim || data.horarioInicio || "00:00",
    );
    ...
    formData.append(
      "capacidade_maxima",
      String(Number(data.capacidadeMaxima) || 0),
    );
    formData.append(
      "segmento_alvo",
      data.segmento || data.publicoAlvo || "Geral",
    );
    formData.append("status", data.status || "agendado");
    formData.append("objetivo", data.objetivo || "");
    formData.append("observacoes", data.observacoes || "");
    formData.append("responsavel", data.responsavel || "Admin");
    formData.append("area_responsavel", data.areaResponsavel || "");
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      if (selectedFile.size > 10 * 1024 * 1024) {
        toast.error("O arquivo não pode passar de 10MB.");
        return;
      }
      setMaterialArquivo(selectedFile);
    }
  };
  ...
  const inputBase =
    "w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#D93030] focus:border-transparent focus:bg-white transition-colors text-sm text-gray-900 min-h-[44px]";
  const inputError =
    "w-full px-3 py-2.5 bg-gray-50 border border-red-500 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent focus:bg-white transition-colors text-sm text-gray-900 min-h-[44px]";
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {isEditing
                ...
                : "Cadastre uma nova ação de capacitação para os lojistas."}
            </p>
          </div>
          ...
          <section className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                ...
                <select {...register("categoria")} className={inputBase}>
              ...
              <div>
                ...
                <select {...register("segmento")} className={inputBase}>
                ...
                <div className="relative">
                  <Popover>
                    <PopoverTrigger asChild>
                      <button
                        type="button"
                        className="absolute inset-y-0 left-0 pl-3 flex items-center z-10 cursor-pointer group"
                      >
                ...
                <div className="relative">
                  ...
                  <select
                    {...register("local_id", {
                      ...
                      onChange: (e) => {
                        const selected = locaisList.find(
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div
                  ...
                  className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg transition-colors cursor-pointer group ${
                    materialArquivo
                    ...
                    {materialArquivo ? (
                      ...
                      <div className="flex flex-col items-center animate-in zoom-in-95 duration-200">
                        ...
                        <p className="text-sm font-semibold text-gray-800 max-w-xs truncate">
                          {materialArquivo.name}
                        </p>
                        <p className="text-xs text-gray-400">
                          {(materialArquivo.size / (1024 * 1024)).toFixed(2)} MB
                        </p>
                        <button
                          type="button"
                          onClick={handleRemoveFile}
                          className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-red-500 bg-red-50 border border-red-200 hover:bg-red-100 px-2.5 py-1 rounded-md transition-colors"
                        >
                      ...
                      <>
                        ...
                        <div className="flex text-sm text-gray-600 justify-center">
                          <span
                            className="relative cursor-pointer bg-transparent rounded-md font-medium hover:opacity-80 focus-within:outline-none"
                            style={{ color: "#D93030" }}
                          >
                        ...
                        <p className="text-xs text-gray-500">
                          PDF, PPTX, DOCX, XLSX até 10MB (Apenas materiais do
                          curso)
                        </p>
                      </>
                    )}
          ...
          <section className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                ...
                <select {...register("areaResponsavel")} className={inputBase}>
                  <option value="" disabled>
                    Selecione a área
                  </option>
              ...
              <div>
                ...
                {isRecorrente && (
                  <div className="mt-3 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <select {...register("frequencia")} className={inputBase}>
                      <option value="" disabled>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full mx-4 overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Todas as informações preenchidas serão perdidas. Deseja
                realmente voltar para a lista de treinamentos?
              </p>
